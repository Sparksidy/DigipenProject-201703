...
/*
  g_flockUI.AddStatic(IDC_SEPARATIONTXT, L"Separation", -60, iY += 25, 100, 20);
  g_flockUI.AddSlider(IDC_SEPARATION, -60, iY += 25, 200, 20, 0, 100, 50);*/
  ...
  g_flockUI.AddSlider(IDC_SEPARATIONDISTANCE, -60, iY += 25, 200, 20, 0, 100, 50);
	...
	D3DXVECTOR3 vEye(.5f, 1.55f, -1.4f);
