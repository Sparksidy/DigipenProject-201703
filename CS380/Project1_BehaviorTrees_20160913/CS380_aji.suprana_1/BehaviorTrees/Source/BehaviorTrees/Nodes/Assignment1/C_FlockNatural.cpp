...
Returns:        None.
*---------------------------------------------------------------------------*/
void C_FlockNatural::OnInitial(NodeData *nodedata_ptr)
{
...
*---------------------------------------------------------------------------*/
Status C_FlockNatural::OnEnter(NodeData *nodedata_ptr)
{
...
Returns:        None.
*---------------------------------------------------------------------------*/
void C_FlockNatural::OnExit(NodeData *nodedata_ptr)
{
...
Returns:        Status:			return status.
*---------------------------------------------------------------------------*/
Status C_FlockNatural::OnUpdate(float dt, NodeData *nodedata_ptr)
{
...
Returns:        Status:			return status.
*---------------------------------------------------------------------------*/
Status C_FlockNatural::OnSuspend(NodeData *nodedata_ptr)
{
