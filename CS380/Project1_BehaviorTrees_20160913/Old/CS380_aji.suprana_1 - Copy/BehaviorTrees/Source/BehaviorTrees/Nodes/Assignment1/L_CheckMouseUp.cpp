...
Returns:        None.
*---------------------------------------------------------------------------*/
void L_CheckMouseUp::OnInitial(NodeData *nodedata_ptr)
{
...
*---------------------------------------------------------------------------*/
Status L_CheckMouseUp::OnEnter(NodeData *nodedata_ptr)
{
...
Returns:        None.
*---------------------------------------------------------------------------*/
void L_CheckMouseUp::OnExit(NodeData *nodedata_ptr)
{
...
Returns:        Status:			return status.
*---------------------------------------------------------------------------*/
Status L_CheckMouseUp::OnUpdate(float dt, NodeData *nodedata_ptr)
{
...
Returns:        Status:			return status.
*---------------------------------------------------------------------------*/
Status L_CheckMouseUp::OnSuspend(NodeData *nodedata_ptr)
{
