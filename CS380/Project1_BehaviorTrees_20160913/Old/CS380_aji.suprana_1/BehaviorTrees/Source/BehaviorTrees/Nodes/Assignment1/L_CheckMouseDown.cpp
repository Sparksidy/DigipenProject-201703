...
Returns:        None.
*---------------------------------------------------------------------------*/
void L_CheckMouseDown::OnInitial(NodeData *nodedata_ptr)
{
...
*---------------------------------------------------------------------------*/
Status L_CheckMouseDown::OnEnter(NodeData *nodedata_ptr)
{
...
Returns:        None.
*---------------------------------------------------------------------------*/
void L_CheckMouseDown::OnExit(NodeData *nodedata_ptr)
{
...
Returns:        Status:			return status.
*---------------------------------------------------------------------------*/
Status L_CheckMouseDown::OnUpdate(float dt, NodeData *nodedata_ptr)
{
  ...
  std::cout << std::setprecision(3) << "(" << customdata->m_mousePos.x <<  ","<<customdata->m_mousePos.z << ")" << std::endl ;
...
Returns:        Status:			return status.
*---------------------------------------------------------------------------*/
Status L_CheckMouseDown::OnSuspend(NodeData *nodedata_ptr)
{
