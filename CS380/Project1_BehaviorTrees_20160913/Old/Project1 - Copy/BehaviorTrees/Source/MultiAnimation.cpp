...
#define	IDC_COHESION	 20
#define IDC_COHESIONTXT 21
#define	IDC_ALIGNMENT	 22
#define IDC_ALIGNMENTTXT 23
#define	IDC_SEPARATION	 24
#define IDC_SEPARATIONTXT 25
...
void InitApp()
{
  ...
  g_HUD.AddStatic(IDC_COHESIONTXT, L"Cohesion", -60, iY += 25, 100, 20);
  g_HUD.AddSlider(IDC_COHESION, -60, iY += 25, 200, 20, 0, 100, 50);

  g_HUD.AddStatic(IDC_ALIGNMENTTXT, L"Alignment", -60, iY += 25, 100, 20);
  g_HUD.AddSlider(IDC_ALIGNMENT, -60, iY += 25, 200, 20, 0, 100, 50);

  g_HUD.AddStatic(IDC_SEPARATIONTXT, L"Separation", -60, iY += 25, 100, 20);
  g_HUD.AddSlider(IDC_SEPARATION, -60, iY += 25, 200, 20, 0, 100, 50);
