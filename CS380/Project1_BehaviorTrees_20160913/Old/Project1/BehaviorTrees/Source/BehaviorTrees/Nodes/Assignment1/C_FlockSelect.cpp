...
Returns:        None.
*---------------------------------------------------------------------------*/
void C_FlockSelect::OnInitial(NodeData *nodedata_ptr)
{
...
*---------------------------------------------------------------------------*/
Status C_FlockSelect::OnEnter(NodeData *nodedata_ptr)
{
...
Returns:        None.
*---------------------------------------------------------------------------*/
void C_FlockSelect::OnExit(NodeData *nodedata_ptr)
{
...
Returns:        Status:			return status.
*---------------------------------------------------------------------------*/
Status C_FlockSelect::OnUpdate(float dt, NodeData *nodedata_ptr)
{
...
Returns:        Status:			return status.
*---------------------------------------------------------------------------*/
Status C_FlockSelect::OnSuspend(NodeData *nodedata_ptr)
{
