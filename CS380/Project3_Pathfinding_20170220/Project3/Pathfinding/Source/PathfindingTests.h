...
public:
	...
	// apply data from MovementData back to Movement
...
private:
	...
	static void PrepareTest(Agent &agent, MovementData &movement_data,
		int heuristic, float weight, bool setpos);

	static void FinishTest(Agent &agent, MovementData &movement_data, bool applypos);
