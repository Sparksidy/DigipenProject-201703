...
public:
 ...
 // void AStarUsesAnalysis( bool enable )					{ m_aStarUsesAnalysis = enable; }
  ...
  bool ComputePathWithTiming(int r, int c, bool newRequest);
  void SetHeuristicWeight(float value) { m_heuristicWeight = value; g_astar.m_heuristicWeight = value; }
  float GetHeuristicWeight() const { return m_heuristicWeight; }
  void SetHeuristicCalc(int value) { m_heuristicCalc = value; g_astar.m_heuristicCalc = value; }
  int GetHeuristicCalc() const { return m_heuristicCalc; }

  void SetSmoothPath(bool enable) { m_smooth = enable; g_astar.m_smooth = enable; }
  bool GetSmoothPath() const { return m_smooth; }
  void SetRubberbandPath(bool enable) { m_rubberband = enable; g_astar.m_rubberband = enable; }
  bool GetRubberbandPath() const { return m_rubberband; }
  void SetStraightlinePath(bool enable) { m_straightline = enable; }

  bool GetStraightlinePath() const { return m_straightline; }
  void SetSingleStep(bool enable) { m_singleStep = enable;  g_astar.m_singleStep = enable; }
  bool GetSingleStep() const { return m_singleStep; }
  void SetExtraCredit(bool enable) { m_extracredit = enable; g_astar.m_extracredit = enable; }
  bool GetExtraCredit() { return m_extracredit; }

  void AStarUsesAnalysis(bool enable) { m_aStarUsesAnalysis = enable;  g_astar.m_aStarUsesAnalysis = enable; }
  bool GetAnalysis() const { return m_aStarUsesAnalysis; }
  void SetFogOfWar(bool enable) { m_fogOfWar = enable; g_astar.m_fogOfWar = enable; }
  bool GetFogOfWar() const { return m_fogOfWar; }
