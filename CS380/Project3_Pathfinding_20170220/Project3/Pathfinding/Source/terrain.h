...
enum OccupancyMapType
{
	//OccupancyMap_None = 0,
	OccupancyMap_Propagation,
	OccupancyMap_PropagationTwo,
	OccupancyMap_PropagationWithNormalizingInfluence,
	OccupancyMap_PropagationTwoWithNormalizingInfluence,
	OccupancyMap_HideAndSeek,
	OccupancyMap_Count
};
...
public:
	...
	inline void SetOccupancyMapValue(int r, int c, float value) { m_terrainOccupancyMap[r][c] = value; }
	inline float GetOccupancyMapValue(int r, int c) { return m_terrainOccupancyMap[r][c]; }
	void ResetInfluenceMap( void );
	void ResetOccupancyMap(void);
