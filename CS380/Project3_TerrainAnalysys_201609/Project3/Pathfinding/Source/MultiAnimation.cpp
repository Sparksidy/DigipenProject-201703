...
bool					g_singleStep = false;	//Default single step
...
INT WINAPI WinMain(HINSTANCE, HINSTANCE, LPSTR, int)
{
  ...
  freopen("CONOUT$", "w", stdout);
	...
	*stdin = *hf_in;
	...
	DXUTCreateWindow(L"Fall 2016 CS380/CS580 Project 2: A* Pathfinding");
  ...
  //AJI
#ifdef TEST
  g_database.SendMsgFromSystem(MSG_CustomTimingTest);
  return S_OK;
#endif
...
void InitApp()
{
  ...
  g_SampleUI.AddButton(IDC_TERRAINDEBUG, L"Test Terrain Debug", 45, iY + 26, 120, 24);
